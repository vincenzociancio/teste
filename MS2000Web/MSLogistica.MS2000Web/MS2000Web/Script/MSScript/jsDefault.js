...
$(document).ready(function () {
    ...
    $("input:text").not(":password").css('text-transform', 'uppercase').css('font-size', '12px').css('font-family', 'verdana');
