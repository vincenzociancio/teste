...
{
    public class Processos_ADICOES_ICMS_PIS_COFINSMap : EntityTypeConfiguration<Processos_ADICOES_ICMS_PIS_COFINS>
    {
        public Processos_ADICOES_ICMS_PIS_COFINSMap()
        {
            // Primary Key
            this.HasKey(t => new { t.Empresa, t.Filial, t.Processo, t.Adicao });
            ...
            this.ToTable("Processos_ADICOES_ICMS_PIS_COFINS");
            ...
            this.Property(t => t.BASEC_ICMS_ACRESC).HasColumnName("BASEC_ICMS_ACRESC");
            this.Property(t => t.VALOR_ICMS_ACRESC).HasColumnName("VALOR_ICMS_ACRESC");
            this.Property(t => t.VALOR_ICMS_ACRESC_EXTRA).HasColumnName("VALOR_ICMS_ACRESC_EXTRA");
