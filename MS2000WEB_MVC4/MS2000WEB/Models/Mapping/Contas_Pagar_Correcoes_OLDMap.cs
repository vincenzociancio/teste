...
{
    public class Contas_Pagar_Correcoes_OLDMap : EntityTypeConfiguration<Contas_Pagar_Correcoes_OLD>
    {
        public Contas_Pagar_Correcoes_OLDMap()
        {
            // Primary Key
            ...
            this.ToTable("Contas_Pagar_Correcoes_OLD");
