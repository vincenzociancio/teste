...
{
    public class Notas_FiscaisMap : EntityTypeConfiguration<Notas_Fiscais>
    {
        public Notas_FiscaisMap()
        {
            // Primary Key
            this.HasKey(t => new { t.Empresa, t.Filial, t.Importador, t.Processo, t.Tiponf, t.NFiscal });
