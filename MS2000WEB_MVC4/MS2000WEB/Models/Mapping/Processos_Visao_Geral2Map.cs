...
{
    public class Processos_Visao_Geral2Map : EntityTypeConfiguration<Processos_Visao_Geral2>
    {
        public Processos_Visao_Geral2Map()
        {
            // Primary Key
            ...
            this.ToTable("Processos_Visao_Geral2");
            ...
            this.Property(t => t.ACERTO_CONFIS).HasColumnName("ACERTO_CONFIS");
        }
    }
}
