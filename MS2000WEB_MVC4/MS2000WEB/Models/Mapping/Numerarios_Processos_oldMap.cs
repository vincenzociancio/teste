...
{
    public class Numerarios_Processos_oldMap : EntityTypeConfiguration<Numerarios_Processos_old>
    {
        public Numerarios_Processos_oldMap()
        {
            // Primary Key
            ...
            this.ToTable("Numerarios_Processos_old");
