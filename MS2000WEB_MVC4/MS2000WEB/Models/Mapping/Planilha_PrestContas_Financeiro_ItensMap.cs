...
{
    public class Planilha_PrestContas_Financeiro_ItensMap : EntityTypeConfiguration<Planilha_PrestContas_Financeiro_Itens>
    {
        public Planilha_PrestContas_Financeiro_ItensMap()
        {
            // Primary Key
            ...
            this.Property(t => t.Planilha_Numerarios)
                .HasMaxLength(50);
            ...
            this.ToTable("Planilha_PrestContas_Financeiro_Itens");
            ...
            this.Property(t => t.Planilha_Numerarios).HasColumnName("Planilha_Numerarios");
            ...
            this.Property(t => t.Vlr_Bruto).HasColumnName("Vlr_Bruto");
