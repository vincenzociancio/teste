...
{
    public class Processos2Map : EntityTypeConfiguration<Processos2>
    {
        public Processos2Map()
        {
            // Primary Key
            this.HasKey(t => new { t.Empresa, t.Filial, t.Codigo, t.Material_Usado });
            ...
            this.Property(t => t.Material_Usado)
