...
{
    public class NF_Web_detalhesMap : EntityTypeConfiguration<NF_Web_detalhes>
    {
        public NF_Web_detalhesMap()
        {
            // Primary Key
            this.HasKey(t => new { t.CNPJ_CPF_COMPLETO, t.Tiponf, t.NFiscal, t.Sequencial, t.Linha });
