...
{
    public class Movimentacao_Repetro_copiaMap : EntityTypeConfiguration<Movimentacao_Repetro_copia>
    {
        public Movimentacao_Repetro_copiaMap()
        {
            // Primary Key
            ...
            this.ToTable("Movimentacao_Repetro_copia");
