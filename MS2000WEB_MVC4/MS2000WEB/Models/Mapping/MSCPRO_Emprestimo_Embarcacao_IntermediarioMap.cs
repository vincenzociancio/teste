...
{
    public class MSCPRO_Emprestimo_Embarcacao_IntermediarioMap : EntityTypeConfiguration<MSCPRO_Emprestimo_Embarcacao_Intermediario>
    {
        public MSCPRO_Emprestimo_Embarcacao_IntermediarioMap()
        {
            // Primary Key
            ...
            this.ToTable("MSCPRO_Emprestimo_Embarcacao_Intermediario");
