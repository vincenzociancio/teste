...
{
    public class MSCPRO_Processos_Acessorios_IntermediarioMap : EntityTypeConfiguration<MSCPRO_Processos_Acessorios_Intermediario>
    {
        public MSCPRO_Processos_Acessorios_IntermediarioMap()
        {
            // Primary Key
            ...
            this.ToTable("MSCPRO_Processos_Acessorios_Intermediario");
            ...
            this.Property(t => t.Data_Arq_GRA).HasColumnName("Data_Arq_GRA");
        }
    }
}
