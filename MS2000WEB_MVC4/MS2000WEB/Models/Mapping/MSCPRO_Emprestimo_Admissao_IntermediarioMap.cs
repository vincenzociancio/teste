...
{
    public class MSCPRO_Emprestimo_Admissao_IntermediarioMap : EntityTypeConfiguration<MSCPRO_Emprestimo_Admissao_Intermediario>
    {
        public MSCPRO_Emprestimo_Admissao_IntermediarioMap()
        {
            // Primary Key
            ...
            this.ToTable("MSCPRO_Emprestimo_Admissao_Intermediario");
