...
{
    public class Repetro_AjustarMap : EntityTypeConfiguration<Repetro_Ajustar>
    {
        public Repetro_AjustarMap()
        {
            // Primary Key
            ...
            this.Property(t => t.NM_TEXTO_IMP).HasColumnName("NM_TEXTO_IMP");
        }
    }
}
