...
{
    public class ProcuradoreMap : EntityTypeConfiguration<Procuradore>
    {
        public ProcuradoreMap()
        {
            // Primary Key
            ...
            this.Property(t => t.exibe_complementares).HasColumnName("exibe_complementares");
