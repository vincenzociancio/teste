...
{
    public class Numerarios_Processos_old2Map : EntityTypeConfiguration<Numerarios_Processos_old2>
    {
        public Numerarios_Processos_old2Map()
        {
            // Primary Key
            ...
            this.ToTable("Numerarios_Processos_old2");
