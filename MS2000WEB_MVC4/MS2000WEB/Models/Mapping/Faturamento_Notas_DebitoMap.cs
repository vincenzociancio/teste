...
{
    public class Faturamento_Notas_DebitoMap : EntityTypeConfiguration<Faturamento_Notas_Debito>
    {
        public Faturamento_Notas_DebitoMap()
        {
            // Primary Key
            this.HasKey(t => t.Pk);
            ...
            this.Property(t => t.Codigo_Planilha)
                .HasMaxLength(8);
            ...
            this.ToTable("Faturamento_Notas_Debito");
            this.Property(t => t.Pk).HasColumnName("Pk");
            this.Property(t => t.Nota).HasColumnName("Nota");
            this.Property(t => t.Codigo_Planilha).HasColumnName("Codigo_Planilha");
            this.Property(t => t.Processo).HasColumnName("Processo");
            this.Property(t => t.Cliente).HasColumnName("Cliente");
            this.Property(t => t.Data).HasColumnName("Data");
            this.Property(t => t.Requisicao).HasColumnName("Requisicao");
