...
{
    public partial class ItensFaturas2
    {
        ...
        public Nullable<int> Item_Admissivel { get; set; }
        public Nullable<double> Rateio_carga_descarga_manuseio { get; set; }
        public Nullable<double> Rateio_Acresc_ICMS { get; set; }
        public Nullable<double> ATA_FECP { get; set; }
    }
}
