object QR_Controle_veiculos: TQR_Controle_veiculos
  Tag = 1
  Left = 0
  Top = 0
  Width = 317
  ...
  object QRSubDetail2: TQRSubDetail
    ...
    object QRLabel18: TQRLabel
      ...
      AutoSize = True
      AutoStretch = False
      Caption = 'REGRAS PARA USO DO CARRO DA EMPRESA'
      Color = clWhite
      Font.Charset = DEFAULT_CHARSET
      Font.Color = clWindowText
      Font.Height = -15
    ...
    object QRMemo1: TQRMemo
      ...
      Lines.Strings = (
          ...
          'Série_________, confirmo que recebi nesta data ____________, o v' +
          'eiculo __________________,'
        
          'placa________________, quilometragem_______________, em perfeito' +
          ' estado, devendo conserva-lo'
        'desta maneira.'
        ''
        ''
        ''
        
          'O uso do veiculo acima é única e exclusivamente para trabalho, d' +
          'evendo ser deixado na garagem,'
        
          'ou garagem que a empresa determinar no final do expediente, o ca' +
          'rro da empresa não deve ser usado'
        'em hipótese nenhuma  para fins particulares.'
        
          'Estou ciente que sou o único condutor do carro, respondendo por ' +
          'quaisquer danos e multas que possam'
        'ocorrer.'
        
          'Devo respeitar as regras de transito do código nacional de trans' +
          'ito assim como as regras contidas neste '
        'documento.'
        
          'Qualquer problema com o automóvel deve ser comunicado imediatame' +
          'nte para a empresa.'
        'Esta proibido qualquer tipo de carona.'
        
          'A MS Logística esta isenta de qualquer dano que possa ocorrer, c' +
          'aso as regras da empresa e do código'
        'transito não sejam cumpridas.'
        
          'Nos casos de passageiros autorizados pela empresa, os mesmos dev' +
          'em estar de cinto de segurança'
        ...
        'REGRAS GERAIS'
        ''
        'Só liberar o carro com todos os campos preenchidos;'
        ''
        'Só aceitar o carro após a vistoria;'
        ''
        
          'Os recibos de pedágio, estacionamento, gasolina e outros devem e' +
          'star anexados a este;'
        ''
        'Os reembolsos só serão pagos mediante as etapas acima.'
        ' ')
      ParentFont = False
      Transparent = False
      WordWrap = True
