object QR_fabricantes: TQR_fabricantes
  Left = 0
  Top = 0
  Width = 1123
  Height = 794
  ...
  object q_Fabric: TQuery
    ...
    SQL.Strings = (
        ...
        'SELECT I.Empresa, I.Filial, I.Codigo, I.Razao_Social, TP.DESCRIC' +
        'AO, I.CGC_CPF, I.Endereco, I.Numero, I.Complemento, I.Bairro, I.' +
        'Cidade, I.CEP, I.UF, I.Inscricao_Estadual'
      
        'FROM (Parametros AS P INNER JOIN Fabricantes_Produtores AS I ON ' +
        'P.Filial = I.Filial AND P.Empresa = I.Empresa) LEFT JOIN TAB_PAI' +
        'S AS TP ON I.Pais = TP.CODIGO'
      'ORDER BY I.Razao_Social')
    Left = 16
    Top = 8
    object q_FabricEmpresa: TStringField
      FieldName = 'Empresa'
      FixedChar = True
      Size = 4
    end
    object q_FabricFilial: TStringField
      FieldName = 'Filial'
      FixedChar = True
      Size = 4
    end
    object q_FabricCodigo: TStringField
      FieldName = 'Codigo'
      FixedChar = True
      Size = 4
    end
    object q_FabricRazao_Social: TStringField
      FieldName = 'Razao_Social'
      FixedChar = True
      Size = 60
    end
    object q_FabricDESCRICAO: TStringField
      FieldName = 'DESCRICAO'
      FixedChar = True
      Size = 120
    end
    object q_FabricCGC_CPF: TStringField
      FieldName = 'CGC_CPF'
      FixedChar = True
      Size = 18
    end
    object q_FabricEndereco: TStringField
      FieldName = 'Endereco'
      FixedChar = True
      Size = 40
    end
    object q_FabricNumero: TStringField
      FieldName = 'Numero'
      FixedChar = True
      Size = 6
    end
    object q_FabricComplemento: TStringField
      FieldName = 'Complemento'
      FixedChar = True
      Size = 21
    end
    object q_FabricBairro: TStringField
      FieldName = 'Bairro'
      FixedChar = True
      Size = 25
    end
    object q_FabricCidade: TStringField
      FieldName = 'Cidade'
      FixedChar = True
      Size = 25
    end
    object q_FabricCEP: TStringField
      FieldName = 'CEP'
      FixedChar = True
      Size = 10
    end
    object q_FabricUF: TStringField
      FieldName = 'UF'
      FixedChar = True
      Size = 2
    end
    object q_FabricInscricao_Estadual: TStringField
