object f_compraloc: Tf_compraloc
  Left = 9
  Top = 63
  BorderIcons = [biSystemMenu, biMinimize]
  BorderStyle = bsSingle
  Caption = 'Compras Locais'
  ClientHeight = 408
  ClientWidth = 769
  Color = clBtnFace
  ...
  object q_inventinicial: TQuery
    ...
    SQL.Strings = (
        ...
        '(Movimentacao_Inventario.Processo)="COMPLOC") AND ((Movimentacao' +
        '_Inventario.DI)=".") AND ((Movimentacao_Inventario.ADICAO)="."))'
      
        'ORDER BY Movimentacao_Inventario.Data_movimentacao,Movimentacao_' +
        'Inventario.Fatura;')
    Left = 592
    Top = 38
    ParamData = <
