object F_RelPatrimonio_ind: TF_RelPatrimonio_ind
  Left = 132
  Top = 94
  Width = 818
  Height = 562
  Caption = 'F_RelPatrimonio_ind'
  Color = clBtnFace
  ...
  PixelsPerInch = 96
  TextHeight = 13
  object qrPatrimonio_ind: TQuickRep
    Left = -1
    Top = 0
    Width = 794
    Height = 1123
    ...
    BeforePrint = qrPatrimonio_indBeforePrint
    DataSet = F_Patrimonio.qrPatri
    Description.Strings = (
    ...
    object qrbTitulo: TQRBand
      ...
      object qrl_titulo: TQRLabel
        ...
        AutoSize = True
        AutoStretch = False
        Caption = 'CONTROLE DE PATRIMÔNIOS - FICHA INDIVIDUAL'
        Color = clWhite
        Font.Charset = DEFAULT_CHARSET
        Font.Color = clMaroon
        Font.Height = -13
  ...
  object tb_patri: TTable
    DatabaseName = 'DBNMSCOMEX'
    IndexFieldNames = 'Empresa;Filial;Plaqueta'
    MasterFields = 'Empresa;Filial;Plaqueta'
    MasterSource = F_Patrimonio.dsPatrimonio
    TableName = 'Patrimonio'
    Left = 215
    Top = 16
    object tb_patriEmpresa: TStringField
      FieldName = 'Empresa'
      Required = True
      Size = 4
    end
    object tb_patriFilial: TStringField
      FieldName = 'Filial'
      Required = True
      Size = 4
    end
    object tb_patriPlaqueta: TStringField
      FieldName = 'Plaqueta'
      Required = True
      Size = 6
    end
    object tb_patriDescricao: TStringField
      FieldName = 'Descricao'
      Size = 255
    end
    object tb_patriTipo_Patrimonio: TStringField
      FieldName = 'Tipo_Patrimonio'
      Size = 4
    end
    object tb_patriSub_Tipo_Patrimonio: TStringField
      FieldName = 'Sub_Tipo_Patrimonio'
      Size = 4
    end
    object tb_patriSetor: TStringField
      FieldName = 'Setor'
      Size = 4
    end
    object tb_patriUsuario: TStringField
      FieldName = 'Usuario'
      Size = 10
    end
    object tb_patriNserie: TStringField
      FieldName = 'Nserie'
      Size = 50
    end
    object tb_patriValor: TFloatField
      FieldName = 'Valor'
    end
    object tb_patriFornecedor: TStringField
      FieldName = 'Fornecedor'
      Size = 4
    end
    object tb_patriNfiscal_entrada: TStringField
      FieldName = 'Nfiscal_entrada'
    end
    object tb_patriIP: TStringField
      FieldName = 'IP'
      Size = 15
    end
    object tb_patriPREDE: TStringField
      FieldName = 'PREDE'
      Size = 2
    end
    object tb_patriStatus_Patrimonio: TStringField
      FieldName = 'Status_Patrimonio'
      Size = 4
    end
    object tb_patriOBS: TMemoField
      FieldName = 'OBS'
      BlobType = ftMemo
    end
  end
