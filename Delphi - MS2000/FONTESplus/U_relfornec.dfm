object QR_Fornecedores: TQR_Fornecedores
  Left = 0
  Top = 0
  Width = 1123
  Height = 794
  ...
  object q_Fornec: TQuery
    ...
    SQL.Strings = (
        ...
        'FROM (Parametros AS P INNER JOIN Fornecedores AS I ON P.Filial =' +
        ' I.Filial AND P.Empresa = I.Empresa) LEFT JOIN TAB_PAIS AS TP ON' +
        ' I.Pais = TP.CODIGO'
      'ORDER BY I.Razao_Social')
    Left = 14
    object q_FornecEmpresa: TStringField
      FieldName = 'Empresa'
      FixedChar = True
      Size = 4
    end
    object q_FornecFilial: TStringField
      FieldName = 'Filial'
      FixedChar = True
      Size = 4
    end
    object q_FornecCodigo: TStringField
      FieldName = 'Codigo'
      FixedChar = True
      Size = 4
    end
    object q_FornecRazao_Social: TStringField
      FieldName = 'Razao_Social'
      FixedChar = True
      Size = 60
    end
    object q_FornecDESCRICAO: TStringField
      FieldName = 'DESCRICAO'
      FixedChar = True
      Size = 120
    end
    object q_FornecCGC_CPF: TStringField
      FieldName = 'CGC_CPF'
      FixedChar = True
      Size = 10
    end
    object q_FornecEndereco: TStringField
      FieldName = 'Endereco'
      FixedChar = True
      Size = 40
    end
    object q_FornecNumero: TStringField
      FieldName = 'Numero'
      FixedChar = True
      Size = 6
    end
    object q_FornecComplemento: TStringField
      FieldName = 'Complemento'
      FixedChar = True
      Size = 21
    end
    object q_FornecBairro: TStringField
      FieldName = 'Bairro'
      FixedChar = True
      Size = 25
    end
    object q_FornecCidade: TStringField
      FieldName = 'Cidade'
      FixedChar = True
      Size = 25
    end
    object q_FornecCEP: TStringField
      FieldName = 'CEP'
      FixedChar = True
      Size = 10
    end
    object q_FornecUF: TStringField
      FieldName = 'UF'
      FixedChar = True
      Size = 2
    end
    object q_FornecInscricao_Estadual: TStringField
