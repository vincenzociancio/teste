object F_armazens: TF_armazens
  ...
  object dbgArmazem: TDBGrid
    Left = 8
    Top = 8
    Width = 393
    Height = 219
    DataSource = dsArmazem
    Font.Charset = DEFAULT_CHARSET
    Font.Color = clBlack
    Font.Height = -11
    Font.Name = 'MS Sans Serif'
  ...
  object t_Armazem: TTable
    AfterOpen = t_ArmazemAfterScroll
    AfterScroll = t_ArmazemAfterScroll
  ...
  object q_Cargas: TQuery
    ...
    object q_CargasCodArmazem: TStringField
  ...
  object q_Teste: TQuery
    ...
    object q_TesteCodigo: TStringField
      FieldName = 'Codigo'
      Origin = 'DBNMSCOMEX.Armazem.Codigo'
      Size = 3
    end
  end
end
