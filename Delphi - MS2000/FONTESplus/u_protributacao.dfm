object F_proTributacao: TF_proTributacao
  ...
  object p_processo1: TPanel
    ...
    object chkTxConversaodeAmanha: TCheckBox
      ...
      Width = 174
      Height = 17
      Caption = 'Taxa de Conversão de Amanhã'
      Font.Charset = DEFAULT_CHARSET
      Font.Color = clWindow
      Font.Height = -11
      Font.Name = 'MS Sans Serif'
  ...
  object p_processo2: TPanel
    ...
    object DBG_tributositem: TDBGrid
      ...
      Columns = <
        ...
        item
          ...
          Title.Caption = 'Regime Tributação PISCOFINS'
          Visible = True
        end
        item
          Expanded = False
        ...
        item
          ...
          Title.Caption = 'Alíquota Reduzida PIS'
          Visible = True
        end
        item
          Expanded = False
          FieldName = 'PC_ALIQ_REDUZIDA_COFINS'
          Title.Caption = 'Alíquota Reduzida Cofins'
          Visible = True
        end
        item
          Expanded = False
    ...
    object P_tributacao: TPanel
      ...
      object lblMaterialUsado: TLabel
        ...
        Width = 332
        Height = 16
        Caption = 'ESTE PROCESSO CONTÉM MATERIAL USADO'
        Font.Charset = DEFAULT_CHARSET
        Font.Color = clRed
        Font.Height = -13
        Font.Name = 'MS Sans Serif'
      ...
      object GroupBox4: TGroupBox
        ...
        Width = 344
        Height = 220
        Caption = ' II - IMPOSTO DE IMPORTAÇÃO '
        Color = clSilver
        Font.Charset = DEFAULT_CHARSET
        Font.Color = clWindowText
        Font.Height = -11
        ...
        object dbg_trat: TDBGrid
          ...
          Columns = <
            item
              Expanded = False
              FieldName = 'qtratd'
              Title.Caption = 'Tratamento Tributário'
              Width = 106
              Visible = True
            end
            item
    ...
    object gb_senha: TGroupBox
      ...
      Width = 305
      Height = 121
      Caption = ' Senha do Supervisor para exclusão '
      Color = clMaroon
      Font.Charset = DEFAULT_CHARSET
      Font.Color = clWhite
      Font.Height = -11
    ...
    object PanelRepetroICMS: TPanel
      ...
      object Label10: TLabel
        ...
        Width = 325
        Height = 13
        Caption = 'RESOLUÇÃO SEFAZ Nº 631 DE 14 DE MAIO DE 2013'
        Font.Charset = DEFAULT_CHARSET
        Font.Color = clWindowText
        Font.Height = -11
        Font.Name = 'Verdana'
      ...
      object Label11: TLabel
        ...
        AutoSize = False
        Caption = 
          'DISPÕE SOBRE A REDUÇÃO DA BASE DE CÁLCULO DO ICMS EM OPERAÇÃO DE' +
          ' IMPORTAÇÃO DE BENS OU MERCADORIAS PARA APLICAÇÃO NAS INTALAÇÕES' +
      ...
      object Label13: TLabel
        ...
        Height = 13
        Caption = 
          ' A redução de base de cálculo a que se refere o art. 1º desta re' +
          'solução produzirá seus efeitos até 31 de dezembro de 2016.'
        Font.Charset = DEFAULT_CHARSET
        Font.Color = clRed
        Font.Height = -11
        Font.Name = 'Verdana'
