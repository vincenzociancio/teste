...
uses
  ...
  Db, DBTables, ExtCtrls, StdCtrls, ComCtrls, Gauges;

type
  Tf_pendencias = class(TForm)
    q_processos: TQuery;
...
procedure Tf_pendencias.FormActivate(Sender: TObject);
var ok:boolean;
begin
f_pendencias.left := 0;
f_pendencias.top  := 0;
q_processos.close;
q_processos.Params[0].AsString := v_empresa;
q_processos.Params[1].AsString := v_filial;
q_processos.Params[2].AsString := v_usuario;
q_processos.ExecSQL;
...
procedure Tf_pendencias.FormClose(Sender: TObject;
