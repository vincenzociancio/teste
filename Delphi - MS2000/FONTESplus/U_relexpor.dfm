object QR_exportadores: TQR_exportadores
  Left = 0
  Top = 0
  Width = 1123
  Height = 794
  ...
  object q_Export: TQuery
    ...
    SQL.Strings = (
        ...
        'FROM (Parametros AS P INNER JOIN Exportadores AS I ON P.Filial =' +
        ' I.Filial AND P.Empresa = I.Empresa) LEFT JOIN TAB_PAIS AS TP ON' +
        ' I.Pais = TP.CODIGO'
      'ORDER BY I.Razao_Social')
    Left = 10
    object q_ExportEmpresa: TStringField
      FieldName = 'Empresa'
      FixedChar = True
      Size = 4
    end
    object q_ExportFilial: TStringField
      FieldName = 'Filial'
      FixedChar = True
      Size = 4
    end
    object q_ExportCodigo: TStringField
      FieldName = 'Codigo'
      FixedChar = True
      Size = 4
    end
    object q_ExportRazao_Social: TStringField
      FieldName = 'Razao_Social'
      FixedChar = True
      Size = 60
    end
    object q_ExportDESCRICAO: TStringField
      FieldName = 'DESCRICAO'
      FixedChar = True
      Size = 120
    end
    object q_ExportCGC_CPF: TStringField
      FieldName = 'CGC_CPF'
      FixedChar = True
      Size = 18
    end
    object q_ExportEndereco: TStringField
      FieldName = 'Endereco'
      FixedChar = True
      Size = 40
    end
    object q_ExportNumero: TStringField
      FieldName = 'Numero'
      FixedChar = True
      Size = 6
    end
    object q_ExportComplemento: TStringField
      FieldName = 'Complemento'
      FixedChar = True
      Size = 21
    end
    object q_ExportBairro: TStringField
      FieldName = 'Bairro'
      FixedChar = True
      Size = 25
    end
    object q_ExportCidade: TStringField
      FieldName = 'Cidade'
      FixedChar = True
      Size = 25
    end
    object q_ExportCEP: TStringField
      FieldName = 'CEP'
      FixedChar = True
      Size = 10
    end
    object q_ExportUF: TStringField
      FieldName = 'UF'
      FixedChar = True
      Size = 2
    end
    object q_ExportInscricao_Estadual: TStringField
