...
var
  f_conpendencias: Tf_conpendencias;
...
procedure Tf_conpendencias.FormActivate(Sender: TObject);
var ok:boolean;
begin
...
re_pendencias.Lines.Add('Pendências do Usuário: '+t_usuariosnome_completo.asstring+' - Data: '+datetostr(date())+' - Horário: '+timetostr(time()));
...
procedure Tf_conpendencias.FormClose(Sender: TObject;
...
procedure Tf_conpendencias.b_imprimeClick(Sender: TObject);
begin
re_pendencias.print('');
end;
