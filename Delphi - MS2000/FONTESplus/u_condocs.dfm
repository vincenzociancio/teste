object f_condocs: Tf_condocs
  ...
  object pnlPrincipal: TPanel
    ...
    object btnLocalizar: TBitBtn
      ...
      Width = 107
      Height = 25
      Hint = 'Localizar Documento pelo Número'
      Caption = '&Localizar'
      Enabled = False
      ParentShowHint = False
      ShowHint = True
    ...
    object Panel2: TPanel
      ...
      object dbgDoc: TDBGrid
        ...
        Columns = <
          ...
          item
            ...
            Title.Caption = 'Número do Documento'
            Width = 153
            Visible = True
          end
          item
          ...
          item
            ...
            Title.Caption = 'Data de Prorrogação'
            Width = 102
            Visible = True
          end
          item
      ...
      object ppro: TPanel
        ...
        Height = 16
        Align = alBottom
        Caption = 'Informações referentes ao controle de Termos de Responsabilidade'
        Color = 10514464
        Font.Charset = DEFAULT_CHARSET
        Font.Color = clWhite
        Font.Height = -13
  ...
  object pnlLocalizar: TPanel
    ...
    object Panel7: TPanel
      ...
      object btnCanLoc: TBitBtn
        ...
        Width = 75
        Height = 25
        Hint = 'Cancelar Localização de Documento'
        Caption = '&Cancelar'
        ParentShowHint = False
        ShowHint = True
        TabOrder = 1
  ...
  object pnlAlterar: TPanel
    ...
    object Panel10: TPanel
      ...
      object btnCanAlt: TBitBtn
        ...
        Width = 75
        Height = 25
        Hint = 'Cancelar Alteração do Documento'
        Caption = '&Cancelar'
        ParentShowHint = False
        ShowHint = True
        TabOrder = 1
    ...
    object paltpro: TPanel
      ...
      object Panel8: TPanel
        ...
        Align = alTop
        Caption = 
          'Alterar - Informações referentes ao controle de Termos de Respon' +
          'sabilidade'
        Color = 10514464
        Font.Charset = DEFAULT_CHARSET
        Font.Color = clWhite
