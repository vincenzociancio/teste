object QR_Ajudantes: TQR_Ajudantes
  ...
  object q_Ajud: TQuery
    ...
    SQL.Strings = (
        ...
        'SELECT I.Empresa, I.Filial, I.Codigo, I.[Razão Social], TP.DESCR' +
        'ICAO, I.[CGC/CPF], I.Endereço, I.Número, I.Complemento, I.Bairro' +
        ', I.Cidade, I.CEP, I.UF, I.[Inscrição Estadual]'
      
        'FROM (Parametros AS P INNER JOIN Ajudantes AS I ON P.Filial = I.' +
        'Filial AND P.Empresa = I.Empresa) LEFT JOIN TAB_PAIS AS TP ON I.' +
        'País = TP.CODIGO'
      'ORDER BY I.[Razão Social]')
    Left = 14
