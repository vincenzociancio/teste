object QR_transportadores: TQR_transportadores
  Left = 0
  Top = 0
  Width = 1123
  Height = 794
  ...
  object q_Transp: TQuery
    ...
    SQL.Strings = (
        ...
        'FROM (Parametros AS P INNER JOIN Transportadores AS I ON P.Filia' +
        'l = I.Filial AND P.Empresa = I.Empresa) LEFT JOIN TAB_PAIS AS TP' +
        ' ON I.Pais = TP.CODIGO'
      'ORDER BY I.Razao_Social')
    Left = 14
    object q_TranspEmpresa: TStringField
      FieldName = 'Empresa'
      FixedChar = True
      Size = 4
    end
    object q_TranspFilial: TStringField
      FieldName = 'Filial'
      FixedChar = True
      Size = 4
    end
    object q_TranspCodigo: TStringField
      FieldName = 'Codigo'
      FixedChar = True
      Size = 4
    end
    object q_TranspRazao_Social: TStringField
      FieldName = 'Razao_Social'
      FixedChar = True
      Size = 60
    end
    object q_TranspDESCRICAO: TStringField
      FieldName = 'DESCRICAO'
      FixedChar = True
      Size = 120
    end
    object q_TranspCGC_CPF: TStringField
      FieldName = 'CGC_CPF'
      FixedChar = True
      Size = 18
    end
    object q_TranspEndereco: TStringField
      FieldName = 'Endereco'
      FixedChar = True
      Size = 40
    end
    object q_TranspNumero: TStringField
      FieldName = 'Numero'
      FixedChar = True
      Size = 6
    end
    object q_TranspComplemento: TStringField
      FieldName = 'Complemento'
      FixedChar = True
      Size = 21
    end
    object q_TranspBairro: TStringField
      FieldName = 'Bairro'
      FixedChar = True
      Size = 25
    end
    object q_TranspCidade: TStringField
      FieldName = 'Cidade'
      FixedChar = True
      Size = 25
    end
    object q_TranspCEP: TStringField
      FieldName = 'CEP'
      FixedChar = True
      Size = 10
    end
    object q_TranspUF: TStringField
      FieldName = 'UF'
      FixedChar = True
      Size = 2
    end
    object q_TranspInscricao_Estadual: TStringField
