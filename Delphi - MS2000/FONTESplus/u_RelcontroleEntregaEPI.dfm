object QR_Controle_EntregaEPI: TQR_Controle_EntregaEPI
  Tag = 1
  Left = 0
  Top = 0
  Width = 898
  ...
  object QRSubDetail1: TQRSubDetail
    ...
    object QRLabel13: TQRLabel
      ...
      AutoSize = False
      AutoStretch = False
      Caption = 'Recebimento / Assinatura do Colaborador'
      Color = clWhite
      Transparent = False
      WordWrap = True
      FontSize = 10
    ...
    object QRMemo1: TQRMemo
      ...
      Lines.Strings = (
          ...
          'Declaro que recebi o(s) Equipamentos de Proteção Individual (EPI' +
          '), abaixo descritos, para meu uso pessoal e obrigatório durante ' +
          'as '
        
          'atividades na empresa. Estou ciente que o Equipamento de Proteçã' +
          'o Individual deverá ser devolvido na troca, ou se me desligar da' +
          ' '
        'empresa, sob pena de indenização conforme CLT.'
        ''
        
          'Declaro também estar ciente de minhas obrigações quanto as norma' +
          's de utilização, limpeza, conservação e guarda (Portaria nº '
        
          '3.214/78), conforme orientação recebida no treinamento desenvolv' +
          'ido comigo.')
      ParentFont = False
      Transparent = False
      WordWrap = True
