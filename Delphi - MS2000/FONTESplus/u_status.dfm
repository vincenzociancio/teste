object f_status: Tf_status
  ...
  object t_Status: TTable
    ...
    AfterOpen = t_StatusAfterScroll
    AfterScroll = t_StatusAfterScroll
  ...
  object q_Proc: TQuery
    ...
    object q_ProcStatus: TStringField
      FieldName = 'Status'
  ...
  object q_Teste: TQuery
    ...
    object q_TesteCODIGO: TStringField
      FieldName = 'CODIGO'
      Origin = 'DBNMSCOMEX.Tipos_status_processos.CODIGO'
      Size = 3
    end
  end
end
