object QR_Procuradores: TQR_Procuradores
  Left = 0
  Top = 0
  Width = 1123
  Height = 794
  ...
  object q_Procu: TQuery
    ...
    SQL.Strings = (
      'SELECT I.*, TP.DESCRICAO'
      
        'FROM (Parametros AS P INNER JOIN Procuradores AS I ON P.Filial =' +
        ' I.Filial AND P.Empresa = I.Empresa) LEFT JOIN TAB_PAIS AS TP ON' +
        ' I.Pais = TP.CODIGO'
      'ORDER BY I.exibe_complementares,I.Razao_Social')
    Left = 14
    object q_ProcuEmpresa: TStringField
      FieldName = 'Empresa'
      FixedChar = True
      Size = 4
    end
    object q_ProcuFilial: TStringField
      FieldName = 'Filial'
      FixedChar = True
      Size = 4
    end
    object q_ProcuCodigo: TStringField
      FieldName = 'Codigo'
      FixedChar = True
      Size = 4
    end
    object q_ProcuRazao_Social: TStringField
      FieldName = 'Razao_Social'
      FixedChar = True
      Size = 60
    end
    object q_ProcuPais: TStringField
      FieldName = 'Pais'
      FixedChar = True
      Size = 3
    end
    object q_ProcuCGC_CPF: TStringField
      FieldName = 'CGC_CPF'
      FixedChar = True
      Size = 18
    end
    object q_ProcuEndereco: TStringField
      FieldName = 'Endereco'
      FixedChar = True
      Size = 40
    end
    object q_ProcuNumero: TStringField
      FieldName = 'Numero'
      FixedChar = True
      Size = 6
    end
    object q_ProcuComplemento: TStringField
      FieldName = 'Complemento'
      FixedChar = True
      Size = 21
    end
    object q_ProcuBairro: TStringField
      FieldName = 'Bairro'
      FixedChar = True
      Size = 25
    end
    object q_ProcuCidade: TStringField
      FieldName = 'Cidade'
      FixedChar = True
      Size = 25
    end
    object q_ProcuCEP: TStringField
      FieldName = 'CEP'
      FixedChar = True
      Size = 10
    end
    object q_ProcuUF: TStringField
      FieldName = 'UF'
      FixedChar = True
      Size = 2
    end
    object q_ProcuEstado: TStringField
      FieldName = 'Estado'
      FixedChar = True
      Size = 25
    end
    object q_ProcuInscricao_Estadual: TStringField
      FieldName = 'Inscricao_Estadual'
      FixedChar = True
      Size = 15
    end
    object q_ProcuRegistro: TStringField
      FieldName = 'Registro'
      FixedChar = True
      Size = 15
    end
    object q_ProcuTelefone: TStringField
      FieldName = 'Telefone'
      FixedChar = True
      Size = 15
    end
    object q_Procuexibe_complementares: TSmallintField
      FieldName = 'exibe_complementares'
    end
    object q_ProcuDESCRICAO: TStringField
      FieldName = 'DESCRICAO'
      FixedChar = True
      Size = 120
    end
