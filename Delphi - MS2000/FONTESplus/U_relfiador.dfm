object QR_fiadores: TQR_fiadores
  Left = 0
  Top = 0
  Width = 1123
  Height = 794
  ...
  object q_Fiador: TQuery
    ...
    SQL.Strings = (
        ...
        'FROM (Parametros AS P INNER JOIN Fiadores AS I ON P.Filial = I.F' +
        'ilial AND P.Empresa = I.Empresa) LEFT JOIN TAB_PAIS AS TP ON I.P' +
        'ais = TP.CODIGO'
      'ORDER BY I.Razao_Social')
    Left = 14
    object q_FiadorEmpresa: TStringField
      FieldName = 'Empresa'
      FixedChar = True
      Size = 4
    end
    object q_FiadorFilial: TStringField
      FieldName = 'Filial'
      FixedChar = True
      Size = 4
    end
    object q_FiadorCodigo: TStringField
      FieldName = 'Codigo'
      FixedChar = True
      Size = 4
    end
    object q_FiadorRazao_Social: TStringField
      FieldName = 'Razao_Social'
      FixedChar = True
      Size = 60
    end
    object q_FiadorDESCRICAO: TStringField
      FieldName = 'DESCRICAO'
      FixedChar = True
      Size = 120
    end
    object q_FiadorCGC_CPF: TStringField
      FieldName = 'CGC_CPF'
      FixedChar = True
      Size = 18
    end
    object q_FiadorEndereco: TStringField
      FieldName = 'Endereco'
      FixedChar = True
      Size = 40
    end
    object q_FiadorNumero: TStringField
      FieldName = 'Numero'
      FixedChar = True
      Size = 6
    end
    object q_FiadorComplemento: TStringField
      FieldName = 'Complemento'
      FixedChar = True
      Size = 21
    end
    object q_FiadorBairro: TStringField
      FieldName = 'Bairro'
      FixedChar = True
      Size = 25
    end
    object q_FiadorCidade: TStringField
      FieldName = 'Cidade'
      FixedChar = True
      Size = 25
    end
    object q_FiadorCEP: TStringField
      FieldName = 'CEP'
      FixedChar = True
      Size = 10
    end
    object q_FiadorUF: TStringField
      FieldName = 'UF'
      FixedChar = True
      Size = 2
    end
    object q_FiadorInscricao_Estadual: TStringField
