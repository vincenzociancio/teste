object F_fabricantes: TF_fabricantes
  Left = 225
  Top = 156
  ...
  object pnlPrincipal: TPanel
    ...
    object btnAlterar: TBitBtn
      ...
      Width = 75
      Height = 25
      Hint = 'Alterar dados do Fabricante'
      Caption = '&Alterar'
      Font.Charset = DEFAULT_CHARSET
      Font.Color = clBlack
      Font.Height = -11
    ...
    object btnImprimir: TBitBtn
      ...
      Width = 75
      Height = 25
      Hint = 'Imprimir dados do Fabricante'
      Caption = '&Imprimir'
      Font.Charset = DEFAULT_CHARSET
      Font.Color = clBlack
      Font.Height = -11
    ...
    object btnFechar: TBitBtn
      ...
      Width = 75
      Height = 25
      Hint = 'Fechar cadastro de Fabricante'
      Caption = '&Fechar'
      Font.Charset = DEFAULT_CHARSET
      Font.Color = clBlack
      Font.Height = -11
  ...
  object t_Fabricantes: TTable
    ...
    TableName = 'Fabricantes_Produtores'
    Left = 160
    ...
    object t_FabricantesRazao_Social: TStringField
      FieldName = 'Razao_Social'
      FixedChar = True
      Size = 60
    end
    object t_FabricantesPais: TStringField
      FieldName = 'Pais'
      FixedChar = True
      Size = 3
    end
    object t_FabricantesCGC_CPF: TStringField
      FieldName = 'CGC_CPF'
      FixedChar = True
      Size = 18
    end
    object t_FabricantesEndereco: TStringField
      FieldName = 'Endereco'
      FixedChar = True
      Size = 40
    end
    object t_FabricantesNumero: TStringField
      FieldName = 'Numero'
      FixedChar = True
      Size = 6
    end
    ...
    object t_FabricantesInscricao_Estadual: TStringField
  ...
  object q_ItensFat: TQuery
    AutoCalcFields = False
    DatabaseName = 'DBNMSCOMEX'
    SQL.Strings = (
      'SELECT PR.Fabricante'
      
        'FROM Parametros AS PA INNER JOIN ItensFaturas AS PR ON PA.Filial' +
        ' = PR.Filial AND PA.Empresa = PR.Empresa'
      'WHERE PR.Fabricante =:fab')
    Left = 400
    ParamData = <
      item
        DataType = ftString
  ...
  object q_Localizar: TQuery
    ...
    object q_LocalizarEmpresa: TStringField
      FieldName = 'Empresa'
      Origin = 'DBNMSCOMEX.Fabricantes_Produtores.Empresa'
      Size = 4
    end
    object q_LocalizarFilial: TStringField
      FieldName = 'Filial'
      Origin = 'DBNMSCOMEX.Fabricantes_Produtores.Filial'
      Size = 4
    end
    ...
    object q_LocalizarPais: TStringField
      FieldName = 'Pais'
      Origin = 'DBNMSCOMEX.Fabricantes_Produtores.Pais'
      Size = 3
    end
    object q_LocalizarCGC_CPF: TStringField
      FieldName = 'CGC_CPF'
      Origin = 'DBNMSCOMEX.Fabricantes_Produtores.CGC_CPF'
      Size = 18
    end
    object q_LocalizarEndereco: TStringField
      FieldName = 'Endereco'
      Origin = 'DBNMSCOMEX.Fabricantes_Produtores.Endereco'
      Size = 40
    end
    object q_LocalizarNumero: TStringField
      FieldName = 'Numero'
      Origin = 'DBNMSCOMEX.Fabricantes_Produtores.Numero'
      Size = 6
    end
    object q_LocalizarComplemento: TStringField
      FieldName = 'Complemento'
      Origin = 'DBNMSCOMEX.Fabricantes_Produtores.Complemento'
      Size = 21
    end
    object q_LocalizarBairro: TStringField
      FieldName = 'Bairro'
      Origin = 'DBNMSCOMEX.Fabricantes_Produtores.Bairro'
      Size = 25
    end
    object q_LocalizarCidade: TStringField
      FieldName = 'Cidade'
      Origin = 'DBNMSCOMEX.Fabricantes_Produtores.Cidade'
      Size = 25
    end
    object q_LocalizarCEP: TStringField
      FieldName = 'CEP'
      Origin = 'DBNMSCOMEX.Fabricantes_Produtores.CEP'
      Size = 10
    end
    object q_LocalizarUF: TStringField
      FieldName = 'UF'
      Origin = 'DBNMSCOMEX.Fabricantes_Produtores.UF'
      Size = 2
    end
    object q_LocalizarEstado: TStringField
      FieldName = 'Estado'
      Origin = 'DBNMSCOMEX.Fabricantes_Produtores.Estado'
      Size = 25
    end
    object q_LocalizarInscricao_Estadual: TStringField
      FieldName = 'Inscricao_Estadual'
      Origin = 'DBNMSCOMEX.Fabricantes_Produtores.Inscricao_Estadual'
      Size = 15
    end
  end
  object q_Fabric: TQuery
    DatabaseName = 'DBNMSCOMEX'
    SQL.Strings = (
      'SELECT Max(Cast(Codigo as integer)) AS Cod'
      
        'FROM Parametros AS PA INNER JOIN Fabricantes_Produtores AS PR ON' +
        ' PA.Empresa = PR.Empresa AND PA.Filial = PR.Filial'
      'WHERE Codigo <> '#39'a1,c'#39)
    Left = 304
    object q_FabricCod: TIntegerField
      FieldName = 'Cod'
    end
  end
end
