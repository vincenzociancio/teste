object QR_Controle_Procedimentos: TQR_Controle_Procedimentos
  Tag = 1
  Left = 0
  Top = 0
  Width = 635
    ...
    object QRMemo1: TQRMemo
      ...
      Lines.Strings = (
        ...
        ''
          ...
          '_____BAIRRO:_________________________.'
        ''
        
          'CIDADE:________________________________________ESTADO:__________' +
        ...
        ''
          ...
          'FINANCEIRO:            NOME:____________________________________' +
          '____________TEL:_________________________.'
        ''
        ...
        ''
          ...
          'OPERACIONAL:        NOME:_______________________________________' +
          '_________TEL:_________________________.'
        ''
        ...
        ''
          ...
          'ENVIO DE SOLICITAÇÃO NUMERÁRIOS:________________________________' +
          '_______________________________________.'
        ''
        
          'REGISTRO: MS (    ) CLIENTE  (    )PAGAMENTO ICMS: MS(    ) CLIE' +
          'NTE  (    ) ARMAZENAGEM: MS(    ) CLIENTE (    )           '
        ''
        
          'BOLETO  (    ) DEPSOSITO(    ) 30 DIAS(    ) COMPENSAÇÃO (    ) ' +
          'CHEQUE  (    ) DEPOSITO          '
        ''
        
          'TRANSPORTADORA:_________________________________________ TRANSIT' +
          'ARIO__________________________________.'
        ''
        ...
        ''
          ...
          'ANALISTA DOCUMENTAL:____________________________________________' +
          '_____________________________________.'
        ''
        
          'CLASSIFICADOR:__________________________________________________' +
          '_______________________________________.'
        ''
        
          'ANALISTA IMPORTAÇÃO:____________________________________________' +
          '______________________________________.'
        ''
        ...
        ''
          ...
          'PREENCHIDO POR:_________________________________________________' +
          '________ EM:________________________')
      Transparent = False
      WordWrap = True
      FontSize = 10
    end
