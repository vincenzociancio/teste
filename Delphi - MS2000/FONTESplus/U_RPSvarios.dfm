object qr_RPSvarios: Tqr_RPSvarios
  Left = 5
  Top = 21
  Width = 1032
  Height = 748
  Caption = 'qr_RPSvarios'
  Color = clBtnFace
  ...
  object q_det: TQuery
    ...
    SQL.Strings = (
      'SELECT * FROM Notas_Fiscais_Servicos_Detalhes '
      'where NFiscal=:qnf'
      'order by reg')
    Left = 128
    Top = 10
    ...
    object q_detEmpresa: TStringField
      FieldName = 'Empresa'
      Origin = 'DBNMSCOMEX.Notas_Fiscais_Servicos_Detalhes.Empresa'
      FixedChar = True
      Size = 4
    end
    object q_detFilial: TStringField
      FieldName = 'Filial'
      Origin = 'DBNMSCOMEX.Notas_Fiscais_Servicos_Detalhes.Filial'
      FixedChar = True
      Size = 4
    end
    object q_detNFiscal: TStringField
      FieldName = 'NFiscal'
      Origin = 'DBNMSCOMEX.Notas_Fiscais_Servicos_Detalhes.NFiscal'
      FixedChar = True
      Size = 6
    end
    object q_detreg: TAutoIncField
      FieldName = 'reg'
      Origin = 'DBNMSCOMEX.Notas_Fiscais_Servicos_Detalhes.reg'
    end
    object q_detUnidade: TStringField
      FieldName = 'Unidade'
      Origin = 'DBNMSCOMEX.Notas_Fiscais_Servicos_Detalhes.Unidade'
      FixedChar = True
      Size = 10
    end
    object q_detQuantidade: TStringField
      FieldName = 'Quantidade'
      Origin = 'DBNMSCOMEX.Notas_Fiscais_Servicos_Detalhes.Quantidade'
      FixedChar = True
      Size = 6
    end
    object q_detDescricao: TStringField
      FieldName = 'Descricao'
      Origin = 'DBNMSCOMEX.Notas_Fiscais_Servicos_Detalhes.Descricao'
      FixedChar = True
      Size = 70
    end
    object q_detValor_unitario: TFloatField
      FieldName = 'Valor_unitario'
      Origin = 'DBNMSCOMEX.Notas_Fiscais_Servicos_Detalhes.Valor_unitario'
    end
    object q_detValor_total: TFloatField
      FieldName = 'Valor_total'
      Origin = 'DBNMSCOMEX.Notas_Fiscais_Servicos_Detalhes.Valor_total'
    end
  end
  object q_nfs: TQuery
    AfterScroll = q_nfsAfterScroll
    DatabaseName = 'DBNMSCOMEX'
    SQL.Strings = (
      'select top 2 nfiscal from Notas_Fiscais_Servicos')
    Left = 80
    Top = 7
