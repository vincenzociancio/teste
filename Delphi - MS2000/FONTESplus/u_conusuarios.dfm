object f_conusuarios: Tf_conusuarios
  Left = 85
  Top = 106
  BorderIcons = [biSystemMenu, biMinimize]
  BorderStyle = bsSingle
  Caption = 'Pendências por Usuário'
  ClientHeight = 409
  ClientWidth = 655
  Color = clBtnFace
  ...
  object Panel4: TPanel
    ...
    object DBGrid1: TDBGrid
      ...
      Options = [dgIndicator, dgRowSelect, dgAlwaysShowSelection, dgConfirmDelete, dgCancelOnExit]
      TabOrder = 1
  ...
  object t_followup: TTable
    ...
    object t_followupSequencial: TStringField
      FieldName = 'Sequencial'
      Size = 4
    end
    ...
    object t_followupEvento: TStringField
      FieldName = 'Evento'
      Size = 120
    end
    ...
    object t_followupObservao: TStringField
