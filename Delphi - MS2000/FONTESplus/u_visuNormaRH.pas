...
procedure TF_visuNormaRH.FormActivate(Sender: TObject);
begin
  qrVisuNorma.close;
...
procedure TF_visuNormaRH.btnAbrirClick(Sender: TObject);
Var
 Pdir : pchar ;
begin
...
procedure TF_visuNormaRH.FormClose(Sender: TObject;
  var Action: TCloseAction);
begin
    f_mscomex.visualizanormasRH.Enabled := True;
    F_visuNormaRH := nil;
    Action := caFree;
end;
