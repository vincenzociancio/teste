object QR_Controle_celular: TQR_Controle_celular
  Tag = 1
  Left = -107
  Top = 0
  Width = 635
  ...
  object QRSubDetail1: TQRSubDetail
    ...
    object QRMemo1: TQRMemo
      ...
      Lines.Strings = (
        ''
          ...
          'MS LOGISTICA ADUANEIRA LTDA, portador da CNH__________________, ' +
          'CTPS nº___________ '
        
          'Série_________, confirmo que recebi nesta data ____________, o a' +
          'parelho __________________,'
        
          'nº________________, serie_______________, em perfeito estado, de' +
          'vendo conserva-lo'
        'desta maneira.'
        ''
        
          'O uso do aparelho acima é única e exclusivamente para trabalho, ' +
          'O uso do mesmo apos o expediente'
        'finais de semana e/ou feriados deve ser previamente autorizado.'
        
          'Estou ciente que sou o único a utilizar o aparelho, devendo resp' +
          'onder por qualquer dano causado. '
        'Devo respeitar as regras  contidas neste documento.'
        
          'Qualquer problema com o aparelho deve ser comunicado imediatamen' +
          'te para a empresa.'
        'A internet deve ser utilizada somente para fins de trabalho'
        
          'A MS Logística esta isenta de qualquer dano que possa ocorrer, c' +
          'aso as regras da empresa '
        'não sejam cumpridas.'
        
          'A MS poderá a qualquer momento descontar as ligações, torpedos, ' +
          'sms, internet e outros que não sejam'
        'utilizados para o trabalho.'
        
          'Nenhum aplicativo pode ser baixado, os programas autorizados ser' +
          'ão instalados pela informática.'
        'O e-mail particular não poderá ser configurado no Smartphone.'
        
          ' Durante as ferias, licenças e qualquer outra ausência do trabal' +
          'ho, o aparelho deve ser devolvido para'
        'o setor responsável.'
        
          'Em caso de roubo, perda ou furto, a empresa reserva-se no direit' +
          'o de descontar o valor do aparelho, das'
        
          'ligações e serviços utilizados e a devolver ou não o aparelho pa' +
          'ra o usuário.'
        ''
    ...
    object QRLabel18: TQRLabel
      ...
      AutoSize = True
      AutoStretch = False
      Caption = 'REGRAS PARA USO DO CELULAR / SMARTPHONE DA EMPRESA'
      Color = clWhite
      Font.Charset = DEFAULT_CHARSET
      Font.Color = clWindowText
      Font.Height = -15
