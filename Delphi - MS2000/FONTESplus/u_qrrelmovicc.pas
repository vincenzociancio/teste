...
procedure Tqr_RelMoviCC.detMovimentBeforePrint(Sender: TQRCustomBand;
  var PrintBand: Boolean);
begin
...
procedure Tqr_RelMoviCC.rodapecreditosBeforePrint(Sender: TQRCustomBand;
  var PrintBand: Boolean);
begin
...
procedure Tqr_RelMoviCC.rodapedebitosBeforePrint(Sender: TQRCustomBand;
  var PrintBand: Boolean);
begin
...
procedure Tqr_RelMoviCC.b_resumoBeforePrint(Sender: TQRCustomBand;
  var PrintBand: Boolean);
begin
...
procedure Tqr_RelMoviCC.titulocreditosAfterPrint(Sender: TQRCustomBand;
  BandPrinted: Boolean);
begin
  vSubCred := 0;
end;

procedure Tqr_RelMoviCC.titulodebitosAfterPrint(Sender: TQRCustomBand;
  BandPrinted: Boolean);
begin
  vSubDeb := 0;
end;
