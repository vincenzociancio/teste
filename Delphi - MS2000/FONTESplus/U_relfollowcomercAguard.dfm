object QR_FollowComercAguard: TQR_FollowComercAguard
  Left = 0
  Top = 0
  Width = 1123
  Height = 794
  ...
  DataSet = f_followcomercial.q_Controle
  ...
  object qrbAguard: TQRBand
    ...
    Frame.DrawRight = False
    AlignToBottom = False
    BeforePrint = qrbAguardBeforePrint
    Color = clWhite
    ForceNewColumn = False
    ForceNewPage = False
    Size.Values = (
    ...
    object QRDBText5: TQRDBText
      ...
      Color = clWhite
      DataSet = f_followcomercial.q_Controle
      DataField = 'Data_Chegada_URF_Cheg'
      Font.Charset = DEFAULT_CHARSET
      Font.Color = clWindowText
      Font.Height = -11
      Font.Name = 'Arial'
