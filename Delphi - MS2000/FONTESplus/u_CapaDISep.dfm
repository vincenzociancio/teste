object frmCapaDISep: TfrmCapaDISep
  Left = 201
  Top = 157
  BorderStyle = bsSingle
  Caption = 'Capa DI Sepetiba'
  ClientHeight = 494
  ClientWidth = 682
  Color = clBtnFace
  ...
  object ScrollBox1: TScrollBox
    ...
    object edtCmp4: TRichEdit
      ...
      Lines.Strings = (
          ...
          #9'Vimos, por intermédio desta, solicitara V. Sa. o desembaraço re' +
          'ferente a D.I. em epigrafe. '
        ' ')
      ParentFont = False
      ScrollBars = ssBoth
      TabOrder = 3
    ...
    object cbCmp6: TCheckBox
      ...
      Width = 313
      Height = 17
      Caption = 'CERTIFICADO DE INSPEÇÃO AGRICULTURA'
      Font.Charset = DEFAULT_CHARSET
      Font.Color = clWhite
      Font.Height = -11
      Font.Name = 'MS Sans Serif'
