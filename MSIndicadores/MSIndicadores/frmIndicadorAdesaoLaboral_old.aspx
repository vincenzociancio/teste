<%@ Page Title="" Language="C#" MasterPageFile="~/master.Master" AutoEventWireup="true" CodeBehind="frmIndicadorAdesaoLaboral_old.aspx.cs" Inherits="MSIndicadores.frmIndicadorAdesaoLaboral" %>
    ...
    ViewStateMode="Enabled" Width="992px" BackColor="" 
        ...
        <ChartAreas>
            <asp:ChartArea Name="ChartArea1" BackColor="OldLace" 
                ...
                <InnerPlotPosition Height="87" Width="80" X="11.4223" Y="2.45206" />
            </asp:ChartArea>
        </ChartAreas>
        <Titles>
