...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <asp:Chart ID="Chart1" runat="server" BackColor="" BackGradientStyle="TopBottom"
        ...
        ImageLocation="" Width="992px" ViewStateMode="Enabled" OnLoad="Chart1_Load">
        <Legends>
        ...
        <Titles>
            <asp:Title Font="Microsoft Sans Serif, 18pt, style=Bold" Name="Title1" Text="Pesquisa de Satisfação 2015">
            </asp:Title>
        </Titles>
        <Series>
            <asp:Series BorderColor="DimGray" BorderWidth="3" Color="Red" IsValueShownAsLabel="True"
                ...
                Font="Microsoft Sans Serif, 14pt, style=Bold" Label="#VAL%" XValueType="Double" YValueType="Double">
            </asp:Series>
            <asp:Series BorderColor="Gray" BorderWidth="3" ChartArea="ChartArea1" Color="Yellow"
                ...
                Name="Series2" ShadowColor="Black" ShadowOffset="2" Label="#VAL%" XValueType="Double" YValueType="Double">
            </asp:Series>
            <asp:Series BorderColor="64, 64, 64" BorderWidth="3" ChartArea="ChartArea1" Color="Green"
                Font="Microsoft Sans Serif, 14pt, style=Bold" IsValueShownAsLabel="True" Legend="Default"
                Name="Series3" ShadowColor="Black" ShadowOffset="2" 
                LabelFormat="{0}%" XValueType="Double" YValueType="Double">
            </asp:Series>
        </Series>
        <ChartAreas>
            <asp:ChartArea BackColor="OldLace" BackGradientStyle="TopBottom" BackSecondaryColor="White"
                ...
                <AxisX IsLabelAutoFit="False" Title="" TitleFont="Microsoft Sans Serif, 16pt, style=Bold">
