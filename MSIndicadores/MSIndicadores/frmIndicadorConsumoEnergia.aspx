...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <series>
        ...
        <asp:Series BorderWidth="5" ChartArea="ChartArea1" ChartType="Line" MarkerSize="8" MarkerStyle="Circle" Legend="Default" Name="Series3" Font="Microsoft Sans Serif, 12pt" IsValueShownAsLabel="True" ShadowColor="Black" ShadowOffset="3">
        </asp:Series>
        <asp:Series BorderWidth="5" ChartArea="ChartArea1" ChartType="Line" MarkerSize="8" MarkerStyle="Circle" Font="Microsoft Sans Serif, 12pt" IsValueShownAsLabel="True" Legend="Default" Name="Series4" ShadowColor="Black" ShadowOffset="3">
        </asp:Series>
    </series>
            ...
            <chartareas>
                <asp:ChartArea BackColor="OldLace" BackGradientStyle="TopBottom" 
                    ...
                    <axisy IsLabelAutoFit="False" LineColor="64, 64, 64, 64" 
                        Title="Consumo efetivo" TitleFont="Microsoft Sans Serif, 14pt">
