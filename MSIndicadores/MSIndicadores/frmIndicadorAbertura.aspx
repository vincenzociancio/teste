<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="frmIndicadorAbertura.aspx.cs" Inherits="MSIndicadores.frmIndicadorAbertura" MasterPageFile="~/master.Master"%>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
        <asp:CHART ID="Chart1" runat="server" BackColor="" 
            ...
            <Titles>                
                <asp:Title Font="Microsoft Sans Serif, 18pt, style=Bold" Name="Title1" Text="Processos Abertos">
                </asp:Title>
            ...
            <series>
                ...
                <asp:Series BorderColor="180, 26, 59, 105" BorderWidth="3" ChartType="Line" 
                    ...
                    Font="Microsoft Sans Serif, 12pt">
                     ...
                     <asp:Series BorderColor="180, 26, 59, 105" BorderWidth="3" ChartType="Line" 
                    Color="LimeGreen" IsValueShownAsLabel="True" MarkerSize="9" 
                    MarkerStyle="Circle" Name="Series3" ShadowColor="Black" ShadowOffset="2" 
                    Font="Microsoft Sans Serif, 12pt">
                </asp:Series>
